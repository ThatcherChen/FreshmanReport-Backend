...
public class studentController {
    ...
    public int countNumber(){
        int number = stuMapper.countNumber()-1;
        return number;
    }
    ...
    public List<gender> countGender() {
        List<gender> numbers = new ArrayList<>();
        numbers = stuMapper.countGender();
        return numbers;
    }
    ...
    public List<major> countMajor() {
        List<major> numbers = new ArrayList<>();
        numbers = stuMapper.countMajor();
        return numbers;
    }
